...
(function Helpers$Members () {
  ...
  function Helpers_GetMemberType (member) {
    var propertyInfo = $T0D().$As(member);
    if (propertyInfo !== null) {
      var result = propertyInfo.get_PropertyType();
    } else {
      var fieldInfo = $T14().$As(member);
      result = (
        (fieldInfo === null)
           ? null
...
(function ProtoReader$Members () {
  ...
  function ProtoReader_StartSubItem (reader) {
    ...
    if (wireType !== $T0A().String) {
      ...
      var num2 = (reader.ReadUInt32Variant(false) | 0);
      if (num2 < 0) {
        throw $thisType.AddErrorData($S0F().Construct(), reader);
      }
      var value = (reader.blockEnd | 0);
      reader.blockEnd = (((reader.position | 0) + num2) | 0);
      num = (reader.depth | 0);
      reader.depth = ((num + 1) | 0);
  ...
  function ProtoReader_TryReadFieldHeader (field) {
    var num2 = new JSIL.BoxedVariable(0);
    var wireType = $asm0E.ProtoBuf.WireType.Variant;
    if (((this.blockEnd | 0) <= (this.position | 0)) || (this.wireType === $T0A().EndGroup)) {
      var result = false;
    } else {
  ...
  function ProtoReader_TryReadUInt32VariantWithoutMoving (trimNegative, /* ref */ value) {
    ...
    if ((this.available | 0) === 0) {
      ...
      if (flag3) {
        ...
        num2 = num;
        num = ((num2 + 1) | 0);
        var num3 = (arg_92_0[num2] >>> 0);
        value.set((value.get() >>> 0) | ((num3 & 127) << 7));
        var flag5 = (num3 & 128) === 0;
        if (flag5) {
          result = 2;
        } else {
          ...
          num2 = num;
          num = ((num2 + 1) | 0);
          num3 = (arg_DD_0[num2] >>> 0);
          value.set((value.get() >>> 0) | ((num3 & 127) << 14));
          var flag7 = (num3 & 128) === 0;
          if (flag7) {
            result = 3;
          } else {
            ...
            num2 = num;
            num = ((num2 + 1) | 0);
            num3 = (arg_129_0[num2] >>> 0);
            value.set((value.get() >>> 0) | ((num3 & 127) << 21));
            var flag9 = (num3 & 128) === 0;
            if (flag9) {
              result = 4;
            } else {
              if ((this.available | 0) === 4) {
              ...
              num3 = (this.ioBuffer[num] | 0);
              value.set((value.get() >>> 0) | (num3 << 28));
              var flag11 = (num3 & 240) === 0;
              if (flag11) {
                result = 5;
              } else {
              ...
              $labelgroup0: 
                while (true) {
                  switch ($label0) {
                    case 0: /* $entry0 */ 
                      if (!(!trimNegative || 
                          ((num3 & 240) !== 240) || ((this.available | 0) < 10))) {
                        var arg_1C0_0 = this.ioBuffer;
                        num2 = ((num + 1) | 0);
                        num = num2;
                        if ((arg_1C0_0[num2] | 0) === 255) {
                          var arg_1D8_0 = this.ioBuffer;
                          num2 = ((num + 1) | 0);
                          num = num2;
                          if ((arg_1D8_0[num2] | 0) === 255) {
                            var arg_1F0_0 = this.ioBuffer;
                            num2 = ((num + 1) | 0);
                            num = num2;
                            if ((arg_1F0_0[num2] | 0) === 255) {
                              var arg_208_0 = this.ioBuffer;
                              num2 = ((num + 1) | 0);
                              num = num2;
                              if ((arg_208_0[num2] | 0) === 255) {
                                var arg_220_0 = this.ioBuffer;
                                num2 = ((num + 1) | 0);
                                var arg_227_0 = (arg_220_0[num2] | 0) === 1;
                                break $labelgroup0;
                              }
                            }
                          }
  ...
  function ProtoReader_TryReadUInt64VariantWithoutMoving (/* ref */ value) {
    ...
    if ((this.available | 0) === 0) {
      ...
      if (flag3) {
        ...
        num2 = num;
        num = ((num2 + 1) | 0);
        var num3 = arg_97_0[num2];
        value.set($T29().op_BitwiseOr(
            value.get(), 
            $T29().op_LeftShift($T29().op_BitwiseAnd(num3, $T29().Create(127, 0, 0)), 7)
          ));
        var flag5 = $T29().op_Equality(
          $T29().op_BitwiseAnd(num3, $T29().Create(128, 0, 0)), 
          $T29().Create(0, 0, 0)
        );
        if (flag5) {
          result = 2;
          ...
          value.set($T29().op_BitwiseOr(
              value.get(), 
              $T29().op_LeftShift($T29().op_BitwiseAnd(num3, $T29().Create(127, 0, 0)), 14)
            ));
          ...
          if (flag7) {
            ...
            value.set($T29().op_BitwiseOr(
                value.get(), 
                $T29().op_LeftShift($T29().op_BitwiseAnd(num3, $T29().Create(127, 0, 0)), 21)
              ));
            ...
            if (flag9) {
              ...
              value.set($T29().op_BitwiseOr(
                  value.get(), 
                  $T29().op_LeftShift($T29().op_BitwiseAnd(num3, $T29().Create(127, 0, 0)), 28)
                ));
              ...
              if (flag11) {
                ...
                value.set($T29().op_BitwiseOr(
                    value.get(), 
                    $T29().op_LeftShift($T29().op_BitwiseAnd(num3, $T29().Create(127, 0, 0)), 35)
                  ));
                ...
                if (flag13) {
                  ...
                  value.set($T29().op_BitwiseOr(
                      value.get(), 
                      $T29().op_LeftShift($T29().op_BitwiseAnd(num3, $T29().Create(127, 0, 0)), 42)
                    ));
                  ...
                  if (flag15) {
                    ...
                    value.set($T29().op_BitwiseOr(
                        value.get(), 
                        $T29().op_LeftShift($T29().op_BitwiseAnd(num3, $T29().Create(127, 0, 0)), 49)
                      ));
                    ...
                    if (flag17) {
                      ...
                      value.set($T29().op_BitwiseOr(
                          value.get(), 
                          $T29().op_LeftShift($T29().op_BitwiseAnd(num3, $T29().Create(127, 0, 0)), 56)
                        ));
                      ...
                      if (flag19) {
                        ...
                        num3 = $T29().FromNumber(this.ioBuffer[num]);
                        value.set($T29().op_BitwiseOr(
                            value.get(), 
                            $T29().op_LeftShift(num3, 63)
                          ));
                        var flag21 = $T29().op_GreaterThan(
                          $T29().op_BitwiseAnd(num3, $T29().Create(16777214, 16777215, 65535)), 
                          $T29().Create(0, 0, 0)
                        );
                        if (flag21) {
                          throw $thisType.AddErrorData($S14().Construct(), this);
...
(function ProtoWriter$Members () {
  ...
  function ProtoWriter_EndSubItem$01 (token, writer, style) {
    ...
    var flag5 = num < 0;
    if (flag5) {
      $thisType.WriteHeaderCore((-num | 0), $T09().EndGroup, writer);
      ...
      switch (style.valueOf()) {
        case 1: 
          ...
          for (var num5 = (num3 >>> 0); (num5 = num5 >>> 7) > 0; ) {
            num2 = num4;
            num4 = ((num2 + 1) | 0);
          }
          var flag6 = num4 === 0;
          if (flag6) {
            ...
            do {
              ...
              num2 = num;
              num = ((num2 + 1) | 0);
              arg_1BF_0[num2] = ((num5 & 127) | 128 & 0xFF);
            } while ((num5 = num5 >>> 7) > 0);
            array[((num - 1) | 0)] = ((array[((num - 1) | 0)] | 0) & -129 & 0xFF);
            writer.position = (((writer.position | 0) + num4) | 0);
  ...
  function ProtoWriter_StartSubItem$03 (instance, writer, allowFixed) {
    ...
    switch ((writer.wireType).valueOf()) {
      ...
      case 5: 
        ...
        num = (writer.flushLock | 0);
        writer.flushLock = ((num + 1) | 0);
        subItemToken = new ($T14())(writer.ioIndex);
  ...
  function ProtoWriter_WriteDouble (value, writer) {
    ...
    if (wireType !== $T09().Fixed64) {
      ...
      var flag2 = $S07().CallStatic($T18(), "IsInfinity", null, value2) && 
  ...
  function ProtoWriter_WriteUInt32Variant (value, writer) {
    ...
    do {
      ...
      arg_30_0[num2] = (((value >>> 0) & 127) | 128 & 0xFF);
      num2 = num;
      num = ((num2 + 1) | 0);
  ...
  function ProtoWriter_WriteUInt64Variant (value, writer) {
    ...
    do {
      ...
      var num2 = (writer.ioIndex | 0);
      writer.ioIndex = ((num2 + 1) | 0);
      arg_33_0[num2] = (($T26().op_BitwiseOr(
...
(function ArrayDecorator$Members () {
  ...
  function ArrayDecorator_Read (value, source) {
    ...
    if (flag) {
      ...
      while ($T0C().HasSubValue(this.packedWireType, source)) {
        basicList.Add($IM00().Call(this.Tail, null, null, source));
      }
  ...
  function ArrayDecorator_Write (value, dest) {
    var list = $T11().$Cast(value);
    var count = ($IM01().Call(list, null) | 0);
...
(function PropertyDecorator$Members () {
  ...
  function PropertyDecorator_GetShadowSetter (model, property) {
    ...
    var instanceMethod = $T0A().GetInstanceMethod(
      reflectedType, 
...
(function SurrogateSerializer$Members () {
  ...
  $loop0: 
    for (var i = 0; i < (methods.length | 0); ) {
    ...
    for (var j = 0; j < (methods.length | 0); ) {
  ...
  function SurrogateSerializer_Read (value, source) {
    var array = JSIL.Array.New($T0F(), [value]);
    value = (this.toTail).Invoke(null, array);
    array[0] = $IM00().Call(this.rootTail, null, value, source);
...
(function TupleSerializer$Members () {
  ...
  function TupleSerializer_Read (value, source) {
    ...
    while ((num2 = (source.ReadFieldHeader() | 0)) > 0) {
      flag = true;
      var flag3 = num2 <= (this.tails.length | 0);
      if (flag3) {
        var protoSerializer = this.tails[((num2 - 1) | 0)];
        array[((num2 - 1) | 0)] = $IM00().Call(this.tails[((num2 - 1) | 0)], null, (
...
(function TypeSerializer$Members () {
  ...
  function TypeSerializer_Read (value, source) {
    ...
    $loop1: 
      for (var i = num2; i < (this.fieldNumbers.length | 0); ) {
...
(function UriDecorator$Members () {
  ...
  function UriDecorator_Read (value, source) {
    var text = $T06().$Cast($IM00().Call(this.Tail, null, null, source));
    return (
      ((text.length | 0) === 0)
         ? null
         : $S00().Construct(text))
...
(function AttributeMap$Members () {
  ...
  function AttributeMap_Create$00 (model, type, inherit) {
    ...
    for (var i = 0; i < (customAttributes.length | 0); ) {
...
(function Node$Members () {
  ...
  function Node_Append (value) {
    ...
    if (this.data === null) {
      ...
      if (flag2) {
        ...
        $S00().CallStatic($T04(), "Copy", null, this.data, array, this.$length);
      } else {
        array = this.data;
      }
    }
  ...
  function Node_Trim () {
    ...
    if (flag) {
      ...
      $S00().CallStatic($T04(), "Copy", null, this.data, destinationArray, this.$length);
...
(function CallbackSet$Members () {
  ...
  function CallbackSet_CheckCallbackParameters (model, method) {
    ...
    for (var i = 0; i < (parameters.length | 0); ) {
      var parameterType = (parameters[i]).get_ParameterType();
...
(function MetaType$Members () {
  ...
  function MetaType_Add$02 (memberNames) {
    ...
    var num = (this.GetNextFieldNumber() | 0);

    for (var i = 0; i < (memberNames.length | 0); ) {
      var num2 = num;
      num = ((num2 + 1) | 0);
      this.Add(num2, memberNames[i]);
      num2 = i;
      i = ((num2 + 1) | 0);
    }
    return this;
    ...
    if (!flag4) {
      ...
      if (flag48) {
        ...
        for (var k = 0; k < (array6.length | 0); k = ((k + 1) | 0)) {
          ...
          if (flag49) {
            var arg_7C4_0 = protoMemberAttribute;
            num2 = num3;
            num3 = ((num2 + 1) | 0);
            arg_7C4_0.Rebase(num2);
          }
        }
      }
      var array7 = array5;
          ...
          if (isAutoTuple) {
            ...
            if (flag7) {
              ...
              for (var enumerator = (this.subTypes).GetEnumerator(); enumerator.MoveNext(); ) {
                ...
                var arg_293_0 = array2;
                var num3 = num2;
                num2 = ((num3 + 1) | 0);
                arg_293_0[num3] = subType.get_Serializer();
              }
            }
            var flag9 = count > 0;
            if (flag9) {
              ...
              for (var enumerator2 = (this.fields).GetEnumerator(); enumerator2.MoveNext(); ) {
                ...
                var arg_2E9_0 = array2;
                num3 = num2;
                num2 = ((num3 + 1) | 0);
                arg_2E9_0[num3] = valueMember2.get_Serializer();
              }
            }
            var basicList = null;
  ...
  function MetaType_GetFields () {
    ...
    $S0F().CallStatic($T24(), "Sort$b1", [$asm0E.ProtoBuf.Meta.ValueMember], array, $T41().Default);
    return array;
  }; 
  ...
  function MetaType_GetSubtypes () {
    ...
    if (flag) {
      ...
      $S13().CallStatic($T24(), "Sort$b1", [$asm0E.ProtoBuf.Meta.SubType], array, $T45().Default);
      result = array;
    }
    return result;
  }; 
  ...
  function MetaType_ResolveTupleConstructor (type, /* ref */ mappedMembers) {
    ...
    if (isAbstract) {
      ...
      if (flag2) {
        ...
        for (var i = 0; i < (instanceFieldsAndProperties.length | 0); ) {
      ...
      if (isList) {
        ...
        if (isAutoTuple) {
          ...
          if (flag2) {
            ...
            for (var i = 0; i < (array2.get().length | 0); ) {
          ...
          if ($T08().IsEnum(this.type)) {
            ...
            if (flag15) {
              ...
              $S13().CallStatic($T24(), "Sort$b1", [$asm0E.ProtoBuf.Meta.SubType], array6, $T45().Default);
              var array7 = array6;
...
(function RuntimeTypeModel$Members () {
  ...
  function RuntimeTypeModel_CascadeDependents (list, metaType) {
    var wireType = new JSIL.BoxedVariable($asm0E.ProtoBuf.WireType.Variant);
    var array = new JSIL.BoxedVariable(null);
    var wireType2 = new JSIL.BoxedVariable($asm0E.ProtoBuf.WireType.Variant);
    var wireType3 = new JSIL.BoxedVariable($asm0E.ProtoBuf.WireType.Variant);
    ...
    if (isList) {
      ...
      if (isAutoTuple) {
        ...
        if (flag4) {
          ...
          for (var i = 0; i < (array.get().length | 0); ) {
            var type = null;
        ...
        try {
          ...
          while ($IM01().Call(enumerator, null)) {
            ...
            if (flag11) {
              var num4 = (this.FindOrAddAuto(type2, false, false, false) | 0);
              if (num4 >= 0) {
                metaType2 = ($T06().$Cast((this.types).get_Item(num4))).GetSurrogateOrBaseOrSelf(false);
  ...
  function RuntimeTypeModel_GetSchema (type) {
    ...
    basicList.CopyTo(array, 0);
    $S0D().CallStatic($T28(), "Sort$b1", [$asm0E.ProtoBuf.Meta.MetaType], array, $T29().Default);
    var flag14 = flag;
    if (flag14) {
