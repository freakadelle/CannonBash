...
(function ImageData$Members () {
  ...
  function ImageData_MemSet$00 (array, value) {
    ...
    for (var num2 = ($T0E().Min$b1($T00())(num, array.length) | 0); i < num2; ) {
      array[($temp00 = i, 
        i = ((i + 1) | 0), 
        $temp00)] = (value | 0);
    }
  ...
  function ImageData_MemSet$01 (array, value) {
    ...
    ((array.length | 0) === 0);
    if (flag) {
      throw $S0E().Construct("array", "Must not be null and not an empty array.");
    }
    var flag2 = (value === null) || 
    ((value.length | 0) === 0);
    if (flag2) {
      throw $S0E().Construct("value", "Must not be null and not an empty array.");
    }
    var num = (value.length | 0);
    var num2 = Math.imul(32, num);
    var num3 = ($T0E().Min$b1($T00())(num2, array.length) | 0);
