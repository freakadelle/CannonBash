...
(function $l$gc__DisplayClass54_1$Members () {
  ...
  function $l$gc__DisplayClass54_1_$lRegisterVelocityAxis$gb__0 (deltaTime) {
    var flag = !(this.CS$$l$g8__locals1.$l$g4__this).GetButton(this.CS$$l$g8__locals1.triggerButtonId);
    if (flag) {
      this.closureOffLastTime = true;
      var result = 0;
    } else {
      var flag2 = this.closureOffLastTime;
      if (flag2) {
...
(function $l$gc__DisplayClass54_2$Members () {
  ...
  function $l$gc__DisplayClass54_2_$lRegisterVelocityAxis$gb__1 (deltaTime) {
    ...
    var result = +(((axis - +this.closureLastValue) / +deltaTime));
    this.closureLastValue = axis;
    return result;
  }; 
...
(function GUIElement$Members () {
  ...
  var $T17 = function () {
    return ($T17 = JSIL.Memoize($asm06.Fusee.Math.Core.MathHelper)) ();
  };
  var $T18 = function () {
