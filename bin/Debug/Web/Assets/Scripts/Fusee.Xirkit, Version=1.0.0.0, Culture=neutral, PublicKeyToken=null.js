...
'use strict';
var $asm0C = JSIL.DeclareAssembly("Fusee.Xirkit, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null");

JSIL.DeclareNamespace("Fusee");
JSIL.DeclareNamespace("Fusee.Xirkit");
/* class Fusee.Xirkit.Animation */ 
...
(function Animation$Members () {
  ...
  function Animation_AddAnimation$b1 (TValue, channel, channelObject, field) {
    var flag = +this._maxDuration < +channel.get_Duration();
    if (flag) {
      this._maxDuration = +channel.get_Duration();
    }
    $S01().CallVirtual("Add", null, this._channels, channel);
    var node = new ($T08())(channel);
    var node2 = new ($T08())(channelObject);
  ...
  function Animation_Animate (time) {
    var $temp00;
  ...
  function Animation_DeleteAnimation (pos) {
    throw $S02().Construct("This method is defunkt since a user has no idea of what to specify at pos");
  }; 
  ...
  JSIL.MakeType({
    ...
    $.Method({Static:false, Public:true }, "AddAnimation", 
      new JSIL.MethodSignature(null, [
          $asm0C.TypeRef("Fusee.Xirkit.Channel`1", ["!!0"]), $.Object, 
          $.String
        ], ["TValue"]), 
    ...
    $.Method({Static:false, Public:true }, "AddChannel", 
      JSIL.MethodSignature.Action($asm0C.TypeRef("Fusee.Xirkit.ChannelBase")), 
...
(function ChainedMemberAccessor$b2$Members () {
  ...
  function ChainedMemberAccessor$b2__ctor (miList, p2o, o2p) {
    ...
    this._pre = JSIL.Array.New($asm0C.Fusee.Xirkit.ChainedMemberAccessor$b2_PrePost.Of($thisType.TPin.get(this), $thisType.TObj.get(this)), miList.length);
    this._post = JSIL.Array.New($asm0C.Fusee.Xirkit.ChainedMemberAccessor$b2_PrePost.Of($thisType.TPin.get(this), $thisType.TObj.get(this)), miList.length);
    this._p2o = p2o;
    this._o2p = o2p;

    for (var i = 0; i < (this._miList.length | 0); i = ((i + 1) | 0)) {
      var memberInfo = this._miList[i];
      var flag = $T05().$Is(memberInfo);
      if (flag) {
        this._pre[i] = $asm0C.Fusee.Xirkit.ChainedMemberAccessor$b2_PrePost.Of($thisType.TPin.get(this), $thisType.TObj.get(this)).New(this, null, new JSIL.MethodPointerInfo($thisType.Of($thisType.TPin.get(this), $thisType.TObj.get(this)), "$l_ctor$gb__7_0", $s00, false, false));
        this._post[i] = $asm0C.Fusee.Xirkit.ChainedMemberAccessor$b2_PrePost.Of($thisType.TPin.get(this), $thisType.TObj.get(this)).New(this, null, new JSIL.MethodPointerInfo($thisType.Of($thisType.TPin.get(this), $thisType.TObj.get(this)), "$l_ctor$gb__7_1", $s01, false, false));
      } else {
        this._pre[i] = $asm0C.Fusee.Xirkit.ChainedMemberAccessor$b2_PrePost.Of($thisType.TPin.get(this), $thisType.TObj.get(this)).New(this, null, new JSIL.MethodPointerInfo($thisType.Of($thisType.TPin.get(this), $thisType.TObj.get(this)), "$l_ctor$gb__7_2", $s02, false, false));
        this._post[i] = $asm0C.Fusee.Xirkit.ChainedMemberAccessor$b2_PrePost.Of($thisType.TPin.get(this), $thisType.TObj.get(this)).New(this, null, new JSIL.MethodPointerInfo($thisType.Of($thisType.TPin.get(this), $thisType.TObj.get(this)), "$l_ctor$gb__7_3", $s03, false, false));
      }
    }
  }; 

  function ChainedMemberAccessor$b2_$l_ctor$gb__7_0 (ii) {
    this._oList[(((ii | 0) + 1) | 0)] = ($T05().$Cast(this._miList[ii])).GetValue(this._oList[ii]);
  }; 
  ...
  function ChainedMemberAccessor$b2_Set (o, val) {
    ...
    for (var j = (((this._miList.length | 0) - 1) | 0); j >= 0; j = ((j - 1) | 0)) {
      this._post[j](j);
    }
  }; 
  ...
  JSIL.MakeType({
    ...
    $.Field({Static:false, Public:false}, "_pre", $jsilcore.TypeRef("System.Array", [$asm0C.TypeRef("Fusee.Xirkit.ChainedMemberAccessor`2+PrePost", [$.GenericParameter("TPin"), $.GenericParameter("TObj")])]));

    $.Field({Static:false, Public:false}, "_post", $jsilcore.TypeRef("System.Array", [$asm0C.TypeRef("Fusee.Xirkit.ChainedMemberAccessor`2+PrePost", [$.GenericParameter("TPin"), $.GenericParameter("TObj")])]));
...
(function ChannelBase$Members () {
  ...
  JSIL.MakeType({
    ...
    $.Property({Static:false, Public:true , Virtual:true }, "Duration", $.Single);
...
(function Channel$b1$Members () {
  ...
  function Channel$b1_add_TimeChanged (value) {
    ...
    do {
      ...
      setChanelValue = $T02().CompareExchange$b1($asm0C.Fusee.Xirkit.Channel$b1_SetChanelValue.Of($thisType.TValue.get(this)))(/* ref */ new JSIL.MemberReference(this, "TimeChanged"), value2, setChanelValue2);
  ...
  function Channel$b1_get_Duration () {
    return (
      (((this._timeline).get_Count() | 0) > 0)
         ? ($T06().ElementAt$b1($asm0C.Fusee.Xirkit.Keyframe$b1.Of($thisType.TValue.get(this)))(this._timeline, ((((this._timeline).get_Count() | 0) - 1) | 0))).get_Time()
         : 0)
    ;
  }; 
  ...
  function Channel$b1_GetValueAt (time) {
    ...
    if (flag) {
      var tValue = JSIL.CloneParameter($thisType.TValue.get(this), ($T06().ElementAt$b1($asm0C.Fusee.Xirkit.Keyframe$b1.Of($thisType.TValue.get(this)))(this._timeline, 0)).get_Value());

    $loop0: 
      for (var i = 1; i < ((this._timeline).get_Count() | 0); i = ((i + 1) | 0)) {
        var flag2 = (+($T06().ElementAt$b1($asm0C.Fusee.Xirkit.Keyframe$b1.Of($thisType.TValue.get(this)))(this._timeline, ((i - 1) | 0))).get_Time() <= +time) && 
        (+time < +($T06().ElementAt$b1($asm0C.Fusee.Xirkit.Keyframe$b1.Of($thisType.TValue.get(this)))(this._timeline, i)).get_Time());
        if (flag2) {
          tValue = JSIL.CloneParameter($thisType.TValue.get(this), this._lerpIt(
              JSIL.CloneParameter($thisType.TValue.get(this), ($T06().ElementAt$b1($asm0C.Fusee.Xirkit.Keyframe$b1.Of($thisType.TValue.get(this)))(this._timeline, ((i - 1) | 0))).get_Value()), 
              JSIL.CloneParameter($thisType.TValue.get(this), ($T06().ElementAt$b1($asm0C.Fusee.Xirkit.Keyframe$b1.Of($thisType.TValue.get(this)))(this._timeline, i)).get_Value()), 
              +($T06().ElementAt$b1($asm0C.Fusee.Xirkit.Keyframe$b1.Of($thisType.TValue.get(this)))(this._timeline, i)).get_Time() - +($T06().ElementAt$b1($asm0C.Fusee.Xirkit.Keyframe$b1.Of($thisType.TValue.get(this)))(this._timeline, ((i - 1) | 0))).get_Time(), 
              +time - +($T06().ElementAt$b1($asm0C.Fusee.Xirkit.Keyframe$b1.Of($thisType.TValue.get(this)))(this._timeline, ((i - 1) | 0))).get_Time()
            ));
          break $loop0;
        }
      }
  ...
  function Channel$b1_SetTick (time) {
  ...
  JSIL.MakeType({
      BaseType: $asm0C.TypeRef("Fusee.Xirkit.ChannelBase"), 
      Name: "Fusee.Xirkit.Channel`1", 
      IsPublic: true, 
      IsReferenceType: true, 
    ...
    $.Method({Static:false, Public:true }, ".ctor", 
      new JSIL.MethodSignature(null, [$asm0C.TypeRef("Fusee.Xirkit.Channel`1+SetChanelValue", [$.GenericParameter("TValue")]), $asm0C.TypeRef("Fusee.Xirkit.Channel`1+LerpFunc", [$.GenericParameter("TValue")])]), 
      Channel$b1__ctor$00
    );

    $.Method({Static:false, Public:true }, ".ctor", 
      new JSIL.MethodSignature(null, [$asm0C.TypeRef("Fusee.Xirkit.Channel`1+LerpFunc", [$.GenericParameter("TValue")])]), 
      Channel$b1__ctor$01
    );

    $.Method({Static:false, Public:true }, ".ctor", 
      new JSIL.MethodSignature(null, [$asm0C.TypeRef("Fusee.Xirkit.Channel`1+LerpFunc", [$.GenericParameter("TValue")]), $.GenericParameter("TValue")]), 
      Channel$b1__ctor$02
    );
    ...
    $.Method({Static:false, Public:false}, "ContainsKey", 
      new JSIL.MethodSignature($.Boolean, [$asm0C.TypeRef("Fusee.Xirkit.Keyframe`1", [$.GenericParameter("TValue")])]), 
    ...
    $.Method({Static:false, Public:true , Virtual:true }, "get_Duration", 
      JSIL.MethodSignature.Return($.Single), 
      Channel$b1_get_Duration
    );
    ...
    $.Method({Static:false, Public:true , Virtual:true }, "SetTick", 
      JSIL.MethodSignature.Action($.Single), 
      Channel$b1_SetTick
    );
    ...
    $.Event({Static:false, Public:true }, "TimeChanged", $asm0C.TypeRef("Fusee.Xirkit.Channel`1+SetChanelValue", [$.GenericParameter("TValue")]));
...
/* delegate Fusee.Xirkit.Channel`1+LerpFunc */ 
...
JSIL.MakeDelegate("Fusee.Xirkit.Channel`1+SetChanelValue", false, ["TValue"], 
  new JSIL.MethodSignature(null, [new JSIL.GenericParameter("TValue", "Fusee.Xirkit.Channel`1+SetChanelValue")]));

/* class Fusee.Xirkit.Channel`1+<>c__DisplayClass20_0 */ 
...
(function $l$gc__DisplayClass20_0$Members () {
  ...
  function $l$gc__DisplayClass20_0_$lContainsKey$gb__0 (t) {
  ...
  JSIL.MakeType({
    ...
    $.Method({Static:false, Public:false}, "$lContainsKey$gb__0", 
      new JSIL.MethodSignature($.Boolean, [$asm0C.TypeRef("Fusee.Xirkit.Keyframe`1", [$.GenericParameter("TValue")])]), 
      $l$gc__DisplayClass20_0_$lContainsKey$gb__0
    );
...
(function Circuit$Members () {
  ...
  JSIL.MakeType({
    ...
    $.Method({Static:false, Public:true }, "AddNode", 
      JSIL.MethodSignature.Action($asm0C.TypeRef("Fusee.Xirkit.Node")), 
      Circuit_AddNode
    );
...
(function FieldAccesssor$b1$Members () {
  ...
  function FieldAccesssor$b1_Get (o) {
    return $thisType.T.get(this).$Cast((this._fieldInfo).GetValue(o));
  }; 
...
(function ConvertingFieldAccessor$b2$Members () {
  ...
  function ConvertingFieldAccessor$b2_Get (o) {
    return this._o2p(JSIL.CloneParameter($thisType.TObj.get(this), $thisType.TObj.get(this).$Cast((this._fieldInfo).GetValue(o))));
  }; 
...
(function Pin$Members () {
  ...
  JSIL.MakeType({
    ...
    $.Method({Static:false, Public:true }, ".ctor", 
      new JSIL.MethodSignature(null, [$asm0C.TypeRef("Fusee.Xirkit.Node"), $.String]), 
      Pin__ctor
    );
    ...
    $.Method({Static:false, Public:true }, "get_N", 
      JSIL.MethodSignature.Return($asm0C.TypeRef("Fusee.Xirkit.Node")), 
      Pin_get_N
    );

    $.Field({Static:false, Public:false}, "_n", $asm0C.TypeRef("Fusee.Xirkit.Node"));

    $.Field({Static:false, Public:false}, "_member", $.String);

    $.Property({Static:false, Public:true }, "N", $asm0C.TypeRef("Fusee.Xirkit.Node"));
...
(function InPin$b1$Members () {
  ...
  function InPin$b1_SetValue (value) {
    var $im00 = $asm0C.Fusee.Xirkit.IMemberAccessor$b1.Of($thisType.T.get(this)).Set;
  ...
  JSIL.MakeType({
      BaseType: $asm0C.TypeRef("Fusee.Xirkit.Pin"), 
    ...
    $.Method({Static:false, Public:true }, ".ctor", 
      new JSIL.MethodSignature(null, [
          ...
          $asm0C.TypeRef("Fusee.Xirkit.IMemberAccessor`1", [$.GenericParameter("T")])
        ]), 
      InPin$b1__ctor
    );
    ...
    $.Event({Static:false, Public:true , Virtual:true }, "ReceivedValue", $asm0C.TypeRef("Fusee.Xirkit.ReceivedValueHandler"));

    $.ImplementInterfaces(
      /* 0 */ $asm0C.TypeRef("Fusee.Xirkit.IInPin")
    );
...
JSIL.MakeInterface(
  "Fusee.Xirkit.IOutPin", true, [], function ($) {
    ...
    $.Method({}, "Detach", JSIL.MethodSignature.Action($asm0C.TypeRef("Fusee.Xirkit.IInPin")));
    $.Property({}, "Member");
  }, []);

/* class Fusee.Xirkit.Keyframe`1 */ 
...
(function Lerp$Members () {
  ...
  JSIL.MakeStaticClass("Fusee.Xirkit.Lerp", true, [], function ($ib) {
    $ = $ib;
...
(function ListSort$b1$Members () {
  ...
  JSIL.MakeType({
    ...
    $.Method({Static:false, Public:true , Virtual:true }, "Compare", 
      new JSIL.MethodSignature($.Int32, [$asm0C.TypeRef("Fusee.Xirkit.Keyframe`1", [$.GenericParameter("TValue")]), $asm0C.TypeRef("Fusee.Xirkit.Keyframe`1", [$.GenericParameter("TValue")])]), 
      ListSort$b1_Compare
    );
...
(function Node$Members () {
  ...
  var $T0F = function () {
    return ($T0F = JSIL.Memoize($asm0C.Fusee.Xirkit.ReceivedValueHandler)) ();
  };
  var $T10 = function () {
  ...
  var $IM00 = function () {
    return ($IM00 = JSIL.Memoize($asm0C.Fusee.Xirkit.IOutPin.GetPinType)) ();
  };
  var $IM01 = function () {
    return ($IM01 = JSIL.Memoize($asm0C.Fusee.Xirkit.IOutPin.Attach)) ();
  };
  var $IM02 = function () {
    return ($IM02 = JSIL.Memoize($asm0C.Fusee.Xirkit.IInPin.add_ReceivedValue)) ();
  };
  var $IM03 = function () {
    return ($IM03 = JSIL.Memoize($asm0C.Fusee.Xirkit.ICalculationPerformer.PerformCalculation)) ();
  };
  var $IM04 = function () {
    return ($IM04 = JSIL.Memoize($asm0C.Fusee.Xirkit.IOutPin.Propagate)) ();
  };
  ...
  function Node_get_InPins () {
    return this._inPinList;
  }; 
  ...
  function Node_get_OutPins () {
    return this._outPinList;
  }; 

  function Node_GetInPin (member, targetType) {
    var $closure0 = new ($T0B())();
    $closure0.member = member;
    var inPin = $T03().prototype.Find.call(this._inPinList, $T0C().New($closure0, null, new JSIL.MethodPointerInfo($asm0C.Fusee.Xirkit.Node_$l$gc__DisplayClass12_0, "$lGetInPin$gb__0", $S03(), false, false)));
    var flag = inPin !== null;
    if (flag) {
    ...
    $IM02().Call(inPin, null, $T0F().New(this, null, new JSIL.MethodPointerInfo($thisType, "OnReceivedValue", $S06(), false, false)));
    return inPin;
  }; 
  ...
  function Node_GetOutPin (member) {
    ...
    $closure0.member = member;
    var outPin = $T02().prototype.Find.call(this._outPinList, $T11().New($closure0, null, new JSIL.MethodPointerInfo($asm0C.Fusee.Xirkit.Node_$l$gc__DisplayClass11_0, "$lGetOutPin$gb__0", $S07(), false, false)));
  ...
  JSIL.MakeType({
    ...
    $.Method({Static:false, Public:false}, "GetOutPin", 
      new JSIL.MethodSignature($asm0C.TypeRef("Fusee.Xirkit.IOutPin"), [$.String]), 
      Node_GetOutPin
    );
    ...
    $.Field({Static:false, Public:false}, "_cp", $asm0C.TypeRef("Fusee.Xirkit.ICalculationPerformer"));
...
(function $l$gc__DisplayClass11_0$Members () {
  ...
  JSIL.MakeType({
    ...
    $.Method({Static:false, Public:false}, "$lGetOutPin$gb__0", 
      new JSIL.MethodSignature($.Boolean, [$asm0C.TypeRef("Fusee.Xirkit.IOutPin")]), 
...
(function $l$gc__DisplayClass12_0$Members () {
  ...
  JSIL.MakeType({
    ...
    $.Method({Static:false, Public:false}, "$lGetInPin$gb__0", 
      new JSIL.MethodSignature($.Boolean, [$asm0C.TypeRef("Fusee.Xirkit.IInPin")]), 
...
(function OutPin$b1$Members () {
  ...
  function OutPin$b1_Attach (other) {
    var $s00 = new JSIL.MethodSignature(null, [$asm0C.TypeRef("Fusee.Xirkit.InPin`1", [$thisType.T.get(this)])]);
    $s00.CallVirtual("Add", null, this._links, $asm0C.Fusee.Xirkit.InPin$b1.Of($thisType.T.get(this)).$Cast(other));
  }; 

  function OutPin$b1_Detach (other) {
    (this._links).Remove($asm0C.Fusee.Xirkit.InPin$b1.Of($thisType.T.get(this)).$Cast(other));
  }; 

  function OutPin$b1_get_InPins () {
    return this._links;
  }; 
  ...
  function OutPin$b1_GetValue () {
    var $im00 = $asm0C.Fusee.Xirkit.IMemberAccessor$b1.Of($thisType.T.get(this)).Get;
  ...
  function OutPin$b1_Propagate () {
    ...
    for (var a$0 = this._links._items, i$0 = 0, l$0 = (this._links._size | 0); i$0 < l$0; ($temp00 = i$0, 
        ...
        $temp00)) {
      var current = a$0[i$0];
      $asm0C.Fusee.Xirkit.InPin$b1.Of($thisType.T.get(this)).prototype.SetValue.call(current, JSIL.CloneParameter($thisType.T.get(this), $thisType.Of($thisType.T.get(this)).prototype.GetValue.call(this)));
    }
  }; 
  ...
  JSIL.MakeType({
    ...
    $.Method({Static:false, Public:true , Virtual:true }, "Attach", 
      JSIL.MethodSignature.Action($asm0C.TypeRef("Fusee.Xirkit.IInPin")), 
      OutPin$b1_Attach
    );
...
(function PinFactory$Members () {
  ...
  JSIL.MakeStaticClass("Fusee.Xirkit.PinFactory", false, [], function ($ib) {
    ...
    $.ExternalMethod({Static:true , Public:true }, "CreateOutPin", 
      new JSIL.MethodSignature($asm0C.TypeRef("Fusee.Xirkit.IOutPin"), [$asm0C.TypeRef("Fusee.Xirkit.Node"), $.String])
    );

    $.ExternalMethod({Static:true , Public:true }, "ReAttachInPin", 
      new JSIL.MethodSignature(null, [$asm0C.TypeRef("Fusee.Xirkit.Node"), $asm0C.TypeRef("Fusee.Xirkit.IInPin")])
    );
